...
$("#unwatchedView, #watchedView, #favoritesView, #untrackedSpan").hide();
...
$("#search").click(function(){
	...
	if (signIn.getUser() !== null) {
		console.log("signIn.getUser();", signIn.getUser());
		$("#untrackedView, #searchSpan, #untrackedSpan").show();
		$("#unwatchedView, #unwatchedSpan, #watchedView, #watchedSpan, #favoritesView, #favoritesSpan").hide();
